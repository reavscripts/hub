...
-- Discord JOIN
local discordInvite = "https://discord.com/invite/8Fxnd74Eyq"

-- Attempt to use RPC (if supported)
...
if http_request then
    ...
    -- Fallback: Notify the user to join manually if RPC isn't supported
